...
class InputItem extends React.Component {
  ...
  render() {
    /* todo The checkbox was worked not right, i made the controlled component,
        ...
        How to do it the right way? I thought to hold the value of this checkbox in Redux Store*/
    return (
      <StyledWrapper>
        <StyledCheckbox
